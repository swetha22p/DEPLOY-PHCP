        ...
        return (
            <div>
                <div className={styles.listSection}>
                    ...
                    <div onClick={() => handleDetailsButtonClick()}>Show Details</div> {/* Button to show details modal */}
                    {detailsModalVisible && <DetailsModal />} {/* Render the details modal if detailsModalVisible is true */}
                </div>
    
                <div>
                    <label htmlFor="numToCache">Number of Records to Cache:</label>
                    <input
                        type="number"
                        id="numToCache"
                        name="numToCache"
                    ...
                    />
                    <button onClick={() => fetchData(numRecords)}>Fetch Data</button>
                </div>
            </div>
        );
    };
        ...
        return (
            ...
            >
                <div>
                    ...
                    {hasImageAndAudio ? (
    <>
         {item.imageUrl !== "null" && item.modalAudioUrl !== "null" ? (
            <>
